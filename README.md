...
2. Download the ray-tracing output files for the adopted scenario.
   - For the 'O1_60' scenario, download the files using [this link](https://drive.google.com/drive/folders/16okocQ9ALKjz3uqooSzYWNHXe1nDBdra?usp=sharing).
   - For the 'I1_2p5' scenario, download the files using this link.
   - For the 'I1_2p4' scenario, download the files using this link.
