...
2. Download the ray-tracing output files for the adopted scenario.
   ...
   - For the 'I1_2p5' scenario, download the folder named 'I1_Ly.zip' using this link.
   - For the 'I1_2p4' scenario, download the folder named 'I1_Lx.zip' using this link.
